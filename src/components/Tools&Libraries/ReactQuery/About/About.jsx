...
const About = () => {
	return (
		<>
			<div className="card col-1 d-flex gap-2 flex-column justify-content-start align-items-start w-100 txtClr py-3 px-3 ps-4 mb-2">
				<h6>What React Query is all about ?</h6>

				{React_Query_notes[0]?.pointers?.map((point, idx) => (
					<ul key={idx}>
						<li>
