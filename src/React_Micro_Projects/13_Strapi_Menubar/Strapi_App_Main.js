...
import { StrapiAppContext } from "./StrapiContext";
import Strapi_App from "./Strapi_App";

export default function Strapi_App_Main() {
				...
				<div
					...
					<div className="card col-1 d-flex flex-column align-items-center w-100 mb-2 bg-gradient">
						<h5 className="my-2 txtClr">
							React Micro Projects - Strapi Submenu App
						</h5>
					</div>
