...
import Color_Codes_Container from "./Color_Codes_Container";

export default function Color_picker_Main() {
				...
				<div
					...
					<div className="card col-1 d-flex flex-column align-items-center w-100 mb-2 bg-gradient">
						<h5 className="my-2 txtClr">
							React Micro Projects - Color Picker App
						</h5>
					</div>
